...
class LMOrderedIterator(object):
    ...
    def get_batch(self, i, bptt=None):
        ...
        seq_len = min(bptt, data_transposed.shape[0] - 1 - i) # # i값이 103227020를 넘지 않는 이상 seq_len = 70
        ...
        로,또,1,등,당,첨 = > 로,또,1    => 로, 등
                        등,당,첨         또, 당
                                        1, 첨
        '''
        data = data_transposed[beg_idx:end_idx] # self.data[0:70],[1:71] ~
        target = data_transposed[i+1:i+1+seq_len] #self.data[1:71],[2:72] ~
